...
public class ItemDao extends AbstractDao<Item, Long> {
    ...
    */
    public static class Properties {
        ...
        public final static Property ReadText = new Property(42, String.class, "readText", false, "READ_TEXT");
        public final static Property WriteText = new Property(43, String.class, "writeText", false, "WRITE_TEXT");
        public final static Property TaskId = new Property(44, long.class, "taskId", false, "TASK_ID");
    };
    ...
    public static void createTable(SQLiteDatabase db, boolean ifNotExists) {
        ...
        db.execSQL("CREATE TABLE " + constraint + "\"ITEM\" (" + //
                ...
                "\"READ_TEXT\" TEXT NOT NULL ," + // 42: readText
                "\"WRITE_TEXT\" TEXT NOT NULL ," + // 43: writeText
                "\"TASK_ID\" INTEGER NOT NULL );"); // 44: taskId
    }
    ...
    protected void bindValues(SQLiteStatement stmt, Item entity) {
        ...
        stmt.bindString(43, entity.getReadText());
        stmt.bindString(44, entity.getWriteText());
        stmt.bindLong(45, entity.getTaskId());
    }
    ...
    public Item readEntity(Cursor cursor, int offset) {
        Item entity = new Item( //
            ...
            cursor.getString(offset + 42), // readText
            cursor.getString(offset + 43), // writeText
            cursor.getLong(offset + 44) // taskId
        );
        return entity;
    }
    ...
    public void readEntity(Cursor cursor, Item entity, int offset) {
        ...
        entity.setReadText(cursor.getString(offset + 42));
        entity.setWriteText(cursor.getString(offset + 43));
        entity.setTaskId(cursor.getLong(offset + 44));
     }
