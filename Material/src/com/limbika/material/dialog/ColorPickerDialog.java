 ...
 */
public class ColorPickerDialog extends SelectorDialog {
	...
	public ColorPickerDialog(Context context) {
		...
		picker.setLayoutParams(new LinearLayout.LayoutParams(metrics.widthPixels/2-BUTTONS_HEIGHT, metrics.widthPixels/2-BUTTONS_HEIGHT));
