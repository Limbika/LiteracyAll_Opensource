 ...
 * It should work fine with most Android versions, but might have some issues on Android 3.1 - 4.04, as setTextSize will
 * only work for the first time. <br/>
...
public class AutoSizeTextView extends TextView {
	...
	private static final int DEFAULT_MAX_TEXT_SIZE = 28;
	...
	public AutoSizeTextView(final Context context, final AttributeSet attrs, final int defStyle) {
		...
		_minTextSize = DEFAULT_MIN_TEXT_SIZE;
		_maxTextSize = DEFAULT_MAX_TEXT_SIZE;
		if (_maxLines == 0)
		...
		_sizeTester = new SizeTester() {
			...
			public int onTestSize(final int suggestedSize, final RectF availableSPace) {
				...
				if (singleline) {
					...
					final StaticLayout layout = new StaticLayout(text, paint, _widthLimit, Alignment.ALIGN_NORMAL, _spacingMult,
							_spacingAdd, true);
